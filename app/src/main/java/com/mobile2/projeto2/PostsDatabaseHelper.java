...
public class PostsDatabaseHelper extends SQLiteOpenHelper {
    ...
    /*
    * The static getInstance() method ensures that only one PostsDatabaseHelper
    ...
    * */
    ...
    public void addPost(Post post) {
        ...
        /*
        * It's a good idea to wrap our insert in a transaction. This helps with performance
    ...
    /*
    * Insert or update a user in the database Since SQLite doesn't
    * support "upsert" we need to fall back on an attempt to UPDATE (in case the
    * user already exists) optionally followed by an INSERT (in case the user does not already exist).
    * Unfortunately, there is a bug with the insertOnConflict method so we need to fall back
    * to the more verbose option of querying for the user's primary key if we did an update.
    * */
    ...
    public List<Post> getAllPosts() {
        ...
        /* SELECT * FROM POSTS LEFT OUTER JOIN USERS ON POSTS.KEY_POST_USER_ID_FK = USERS.KEY_USER_ID */
        ...
        /*
        * "getReadableDatabase()" and "getWriteableDatabase()" return the
        * same object (except under low disk space scenarios)
        * */
